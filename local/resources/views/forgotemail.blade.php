...
<body>
	...
	<div class="container">
	 <h1><?php echo $site_name;?> - Reset Password Link</h1>
	...
	font-weight: normal;line-height: 1.4em;color: #444;margin-top: 10px; padding:10px;">
			...
			<h3> Please change your password given below the link</h3>
			<p> click here - <a href="<?php echo $url;?>/reset/<?php echo $token_key;?>" target="_blank"><?php echo $url;?>/reset/<?php echo $token_key;?></a></p>
