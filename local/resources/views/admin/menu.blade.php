...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a href="<?php echo $url;?>/admin/users"><i class="fa fa-user"></i> Customers </a></li>
				  
				  <li><a href="<?php echo $url;?>/admin/sellers"><i class="fa fa-user"></i> Sellers </a></li>
				  
				  
				  <li><a href="<?php echo $url;?>/admin/shop"><i class="fa fa-shopping-cart"></i> Rhinos </a></li>
				  ...
				  <li><a><i class="fa fa-tag"></i> Jobs <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
				  
				  <li><a href="<?php echo $url;?>/admin/request">Jobs </a></li>
				  <li><a href="<?php echo $url;?>/admin/request-orders">Job Orders </a></li>
				  <?php /*?><li><a href="<?php echo $url;?>/admin/approve_payment_request">Approve Payment</a></li><?php */?>
				  </ul>
				   ...
				   <li><a href="<?php echo $url;?>/admin/dispute"><i class="fa fa-book" aria-hidden="true"></i> Dispute </a></li>
				  ...
				  <li><a href="<?php echo $url;?>/admin/blog"><i class="fa fa-rss-square"></i> Blog </a></li>
