	...
	@endif
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.edit-blog') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }}  
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo $blog[0]->name; ?>" required="required" type="text">
						  @if ($errors->has('name'))
                                    <span class="help-block" style="color:red;">
                                        <strong>That post name is already exists</strong>
                                    </span>
                                @endif
                     ...
                     <div class="item form-group">
                        ...
                        <textarea id="id_cazary_full" class="form-control col-md-7 col-xs-12 txteditor" required="required" name="desc" style="min-height:400px;"><?php echo $blog[0]->description; ?></textarea>
					   </div>
                      </div>
					  ...
					  <?php 
					   $blogphoto="/blog/";
						$path ='/local/images'.$blogphoto.$blog[0]->image;
						if($blog[0]->image!=""){
						?>
					  ...
					  <input type="hidden" name="currentphoto" value="<?php echo $blog[0]->image;?>">
