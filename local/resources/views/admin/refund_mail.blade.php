...
<head>
    ...
    <title>Your payment refunded</title>
...
<body>
	...
	<div class="container">
	 <h1><?php echo $site_name;?> - Your payment refunded</h1>
	...
	font-weight: normal;line-height: 1.4em;color: #444;margin-top: 10px; padding:10px;">
			...
			<h3> Your payment refunded</h3>
			<p> Amount - <?php echo $amount;?> <?php echo $currency;?></p>
